...
async function startExport() {
  ...
  if (currentTab === "qr") {
    ...
    endpoint = `${API_BASE_URL}/v1/auth/qr-and-export`;
    ...
    endpoint = `${API_BASE_URL}/v1/export/token`;
    payload = { url: url, username: user, token: token, uuid: null };
    ...
    endpoint = `${API_BASE_URL}/v1/export/credentials`;
    payload = {
      url: url,
      username: user,
      password: pass,
